...
@click.option("--state-topic", default="smartbin/bin-01/ultra-01/state", type=str, help="MQTT retained fill state topic")
@click.option("--event-topic", default="smartbin/bin-01/ultra-01/events", type=str, help="MQTT fill event topic")
@click.option("--status-topic", default="smartbin/bin-01/ultra-01/status", type=str, help="MQTT fill sensor status topic")
